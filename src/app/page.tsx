  ...
  async function fetchPortfolio() {
    ...
    if (data?.data?.items) {
      ...
      const total = tokens.reduce(
        (sum: number, t: Token) => sum + t.valueUsd,
        0,
      );
      setTotalValue(total);
    }
        ...
        {!connected ? (
          ...
          <div className="text-center py-24">
            ...
            <p className="text-gray-400 text-xl mb-8 max-w-xl mx-auto">
              Connect your Solflare wallet to get real-time portfolio analytics,
              PnL tracking, and market insights powered by Birdeye.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Real-time token balances & values",
                },
                {
                  icon: "🔥",
                  title: "Market Intelligence",
                  desc: "Top movers & volume leaders",
                },
                {
                  icon: "⚡",
                  title: "Transaction History",
                  desc: "Full wallet activity timeline",
                },
              ].map((f) => (
                <div
                  key={f.title}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="col-span-2 bg-gray-900 border border-gray-800 rounded-xl p-5">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="font-semibold flex items-center gap-2">
                    <Wallet size={16} className="text-purple-400" /> Your
                    Portfolio
                  </h2>
                  <button
                    ...
                    {portfolio.slice(0, 8).map((token) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <div
                            className={`text-xs ${(token.priceChange24h || 0) >= 0 ? "text-green-400" : "text-red-400"}`}
                          >
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
                <h2 className="font-semibold flex items-center gap-2 mb-4">
                  <TrendingUp size={16} className="text-green-400" /> Top by
                  Volume
                </h2>
                <div className="space-y-3">
                  {topTokens.slice(0, 8).map((token) => (
                    ...
                    >
                      ...
                      <div className="text-right">
                        ...
                        <div
                          className={`text-xs ${(token.v24hChangePercent || 0) >= 0 ? "text-green-400" : "text-red-400"}`}
                        >
                          {(token.v24hChangePercent || 0) >= 0 ? "+" : ""}
                          {(token.v24hChangePercent || 0).toFixed(1)}%
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-5">
              <h2 className="font-semibold flex items-center gap-2 mb-4">
                <Activity size={16} className="text-blue-400" /> Recent
                Transactions
              </h2>
